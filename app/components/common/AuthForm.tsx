...
// This container component is defined outside AuthForm to prevent re-renders.
const AuthFormContainer: React.FC<{
  children: React.ReactNode;
  isModal?: boolean;
  className?: string;
  isSignUp?: boolean;
}> = ({ children, isModal, className, isSignUp }) => {
  return (
...
export default function AuthForm({
    ...
    (error: FirebaseError): string => {
      switch (error.code) {
        ...
        case "auth/invalid-credential":
          return "Credentials Entered are invalid";
  ...
  }, [isSignUp, router, isModal, onToggleMode]);
